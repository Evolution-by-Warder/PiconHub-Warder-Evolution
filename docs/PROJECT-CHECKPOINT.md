...
- P1 case-level manual approval (2026-09-25): #1009 WHITE was separately approved by Štefan with “beriem” and applied at `picons/0.8w/m7-group/white/1_0_16_7A48_2CB_600_E080000_0_0_0.png`. Its exact candidate is byte-identical to the manually approved #407 candidate (SHA256 `031ab28196abdf16781ebff8f2584ecd6048e3271297ad1bc7c9751bf244756c`); source SHA256 `e271debb5a577149c00881c16ba5525ac872c51fe4ab63a47b6c04f54198d1c6`; prior WHITE SHA256 `e0940a92b71a550d43567c2911450d703c064bb868bcc6d858ceb2711b9e4679`. Both cases retain automatic status REVIEW (8 unsafe two-tone components). This applies only to #1009's exact WHITE destination, not the algorithm or a full-catalog rebuild. Audit: `reports/warder-master-production/phase4-v10-experiment-20260925/CASE-1009-MANUAL-APPROVAL.md` and `.csv`.
- P1 manual visual decision (2026-09-25): #14599 МИР was already corrected earlier; Štefan confirmed the displayed right-hand candidate (“beriem ten pravy”). The candidate was synchronized to the isolated test branch because its file still contained a Phase 3 baseline. Exact WHITE SHA256 `23d3fcc477141c824fb10d72d2098f69d8f0caa0552a7c147581df94c8f35256`; the source and protected color ring/alpha are preserved. This is a reaffirmation/synchronization of one WHITE image, not reopening the case or approving the algorithm/full rebuild. Automated status remains REVIEW. Record and comparison: `reports/warder-master-production/phase4-v10-experiment-20260925/CASE-14599-MANUAL-APPROVAL.md`, `.csv`, and `CASE-14599-MANUAL-APPROVAL.png`.
