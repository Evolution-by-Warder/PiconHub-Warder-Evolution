...
- P1 manual visual decisions (2026-09-25): #10943: upper `SHOW` letters are black. At the circle/W contact, only near-white pixels belonging to the `W` stroke were recolored; the red `O` outline and central red button are preserved from the original source. Final WHITE SHA256 `b9a2e1468c5ed7a235ea784c03ed343507f6056d77e5c364fe4731a7bcf11fed`. #4926: the last `L` in lower `CHANNEL` is black; Štefan approved this exact corrected output on 2026-09-25 (WHITE SHA256 `36a2e9553aaffa9e27b10b20d49691b993733808073c612921ea45b04dfc9b62`). Both automatic statuses remain REVIEW. Case audit and focused comparisons: `reports/warder-master-production/phase4-v10-experiment-20260925/CASE-10943-4926-MANUAL-DECISIONS.md`, `.csv`, `CASE-10943-MANUAL-CORRECTION.jpg`, and `CASE-4926-MANUAL-CORRECTION.jpg`. These are exact case-level manual decisions only.
