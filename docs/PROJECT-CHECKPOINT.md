...
- P1 manual visual decisions (2026-09-25): #13015 was corrected from its own original transparent source using the frozen V9 fit/render and white MASTER, then manually corrected per Štefan's direction: the second glyph's white dot and stem are black where it meets the globe. The orange globe pixels and source alpha are unchanged. Corrected WHITE SHA256 `38a7c762af0645529fbf9e61c5cfff3648950e28d8431ad03958aa792baf0f27`; automatic status remains REVIEW. #1856: Štefan selected the middle/current WHITE output; it remains unchanged. Decision audit and focused comparisons: `reports/warder-master-production/phase4-v10-experiment-20260925/CASE-13015-1856-MANUAL-DECISIONS.md`, `.csv`, `CASE-13015-MANUAL-CORRECTION.jpg`, and `CASE-1856-CURRENT-RETAINED.jpg`. This is a case-level manual correction, not V10 or production approval.
- P1 manual visual decisions (2026-09-25): #10943: upper `SHOW` is black, including the small achromatic white edge of the red `O` corrected at its contact with `W`; the central red button and chromatic source pixels are preserved. Final WHITE SHA256 `fccb5b8f137d2b38b66836c624d1f128572ac79ebe4af51be4e2fdf562ac90d5`. #4926: last `L` in lower `CHANNEL` is black; Štefan approved this exact corrected output on 2026-09-25 (WHITE SHA256 `36a2e9553aaffa9e27b10b20d49691b993733808073c612921ea45b04dfc9b62`). Both automatic statuses remain REVIEW. Case audit and focused comparisons: `reports/warder-master-production/phase4-v10-experiment-20260925/CASE-10943-4926-MANUAL-DECISIONS.md`, `.csv`, `CASE-10943-MANUAL-CORRECTION.jpg`, and `CASE-4926-MANUAL-CORRECTION.jpg`. These are exact case-level manual decisions only.n's instruction: recolor the upper `SHOW` letters black while leaving the central red `O`/button untouched; corrected WHITE SHA256 `14ed7e6cc8b66bc09f66def59f0564cc16a8eba99c8af3fd7ac98e647ee9de30`. #4926 corrected per instruction: recolor only the last `L` in the lower `CHANNEL` text black; corrected WHITE SHA256 `36a2e9553aaffa9e27b10b20d49691b993733808073c612921ea45b04dfc9b62`. Both automatic statuses remain REVIEW. Case audit and focused current-vs-correction comparisons: `reports/warder-master-production/phase4-v10-experiment-20260925/CASE-10943-4926-MANUAL-DECISIONS.md`, `.csv`, `CASE-10943-MANUAL-CORRECTION.jpg`, and `CASE-4926-MANUAL-CORRECTION.jpg`. These are exact case-level manual corrections only.
