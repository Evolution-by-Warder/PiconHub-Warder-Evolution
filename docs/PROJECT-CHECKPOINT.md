...
- Expanded v4 WHITE/BLACK scratch regression (2026-09-25): #14716, #3163, #3133, #3172, #3174, #12062 remained REVIEW and the PASS control remained PASS; all composites were pixel-identical to current outputs, with alpha and protected chromatic pixels unchanged. No AUTO-FIXED case was demonstrated. This is fixture-limited non-regression evidence only, not production approval. Report: `reports/warder-master-production/phase4-v10-experiment-20260925/ADJACENCY-GUARD-V4-BW-REGRESSION.md`.
