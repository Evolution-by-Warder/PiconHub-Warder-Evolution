...
- Case #15551 WHITE output manually approved by Štefan on 2026-09-25: use the V10 test candidate with black text and the red “+”. The approved PNG and per-case audit are committed at `picons/9.0e/ote/white/1_0_1_46E_8_AA_5A0000_0_0_0.png` and `reports/warder-master-production/phase4-v10-experiment-20260925/CASE-15551-MANUAL-APPROVAL.md`; output SHA256 `d4db70d1df947b5f76c56cf1c66b70e2b941ca8b390c1f38a19002a4c92844d8`. The V6 classifier still marked the sample REVIEW due to four two-tone components; this records a human approval for this file only and does not approve the algorithm or production rebuild.
...
- P1 mixed-logo screen (2026-09-25): the existing contact-fraction test was run on 24 additional fixtures; all remained REVIEW, alpha/chromatic preservation checks passed, and the PASS control remained unchanged. Visual spot-checks #10085 and #6019 showed contrast/consistency regressions in their scratch candidates, so neither was applied. Report and audit: `reports/warder-master-production/phase4-v10-experiment-20260925/ADJACENCY-GUARD-P1-24-CASE-SCREEN.md` and `.../ADJACENCY-GUARD-P1-24-CASE-SCREEN-AUDIT.csv`.
